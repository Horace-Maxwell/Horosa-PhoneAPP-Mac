                ...
                TextSpan(
                  ...
                  children: [
                    ...
                    const TextSpan(
                      ...
                      style:
                          TextStyle(fontWeight: FontWeight.w400, height: 1.5),
                    ),
                    const TextSpan(
                      text:
                      '2.2 展示和推送内容：',
                    ...
                    const TextSpan(
                      text:
                      '通过使用收集的信息，我们会向您提供搜索结果、个人化内容、用户研究分析与统计等服务。\n\n',
                      style:
                      TextStyle(fontWeight: FontWeight.w400, height: 1.5),
                    ),
                    TextSpan(
                    ...
                    const TextSpan(
                      text:
                      '7.3 与您或者第三方重大利益相关并可能会导致严重损害的；\n',
                      style:
                      TextStyle(fontWeight: FontWeight.w500, height: 1.5),
                    ),
                    const TextSpan(
                      text:
                      '7.4 与犯罪、司法程序、政府程序等直接相关的；\n',
                      style:
                      TextStyle(fontWeight: FontWeight.w500, height: 1.5),
                    ),
                    const TextSpan(
                    ...
                    const TextSpan(
                      text:
                      '3.2基于法律法规、法律程序、诉讼或政府主管部门强制性要求下。\n\n',
                      style:
                      TextStyle(fontWeight: FontWeight.w500, height: 1.5),
                    ),
                    TextSpan(
                    ...
                    const TextSpan(
                      text:
                      '如您对本隐私政策有任何意见或建议，可通过【我的-意见反馈】页面联系我们。\n',
                      style:
                      TextStyle(fontWeight: FontWeight.w400, height: 1.5),
                    ),
                    const TextSpan(
                    ...
                    const TextSpan(
                      text:
                      '开发者地址:  浙江省杭州市余杭区仓前街道时尚万通城\n',
                      style:
                      TextStyle(fontWeight: FontWeight.w400, height: 1.5),
                    ),
                    const TextSpan(
                      text:
                      '电子邮件: lingmingwenhua@163.com\n',
                      style:
                      TextStyle(fontWeight: FontWeight.w400, height: 1.5),
                    ),
                    const TextSpan(
                      text:
                      '网址: http://daofajia.com/\n\n',
                      style:
                      TextStyle(fontWeight: FontWeight.w400, height: 1.5),
                    ),
                    TextSpan(
